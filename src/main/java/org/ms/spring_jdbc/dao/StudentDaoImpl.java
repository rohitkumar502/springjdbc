...
public class StudentDaoImpl implements StudentDao
{
    ...
    public Student getStudent(int studentId)  {
        ...
        // Method 2: To implement RowMapper interface method "mapRow()" using lambda expression
        //Note: We can implement Functional Interface method using lambda expression without creating an implementing class
